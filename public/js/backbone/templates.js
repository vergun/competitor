...
exports.tweet.header = function anonymous(locals) {
    ...
    with (locals || {}) {
        ...
        buf.push('<dd><a>|</a></dd><dd data-chart="Pie" class="active"><a href="#" class="update-chart chart-types">Pie</a></dd><dd data-chart="Doughnut"><a href="#" class="update-chart chart-types">Doughnut</a></dd><dd data-chart="PolarArea"><a href="#" class="update-chart chart-types">PolarArea</a></dd><dd data-chart="Bar"><a href="#" class="update-chart chart-types">Bar</a></dd><dd data-chart="Line"><a href="#" class="update-chart chart-types">Line</a></dd><dd data-chart="Radar"><a href="#" class="update-chart chart-types">Radar</a></dd><dd><a>|</a></dd><dd><a href="#" data-reveal-id="date-modal">Date range</a></dd><dd class="active formatted-dates"><a href="#" data-reveal-id="remove-date-modal">Today</a></dd></dl></div>');
    }
    return buf.join("");
};
