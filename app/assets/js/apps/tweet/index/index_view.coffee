@Competitor.module "TweetApp.Index", (Index, App, backbone, Marionette, $, _) ->
  ...
  class Index.Header extends App.Views.ItemView
    ...
    updateNavbarDates: -> ## todo move navbar dates its own view so ui bindings work
      $('.formatted-dates a').text(@model.get('formattedDates'))
