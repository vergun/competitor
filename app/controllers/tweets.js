...
(function() {
  var Tweet, User, chartsHelper, moment, mongoose, utils, _;
  ...
  */
  ...
  exports.load = function(req, res, next, id) {
    return Tweet.load(id, function(err, tweet) {
      if (err) {
        return next(err);
      }
      if (!tweet) {
  ...
  exports.getChartData = function(req, res, next, query) {
    ...
    if (req.isAuthenticated()) {
      ...
      return Tweet.list(options, function(err, tws) {
        var arrayOfTweetsLanguage, arrayOfTweetsSource, complex, data, graphData;
        if (err) {
          return next(err);
        }
        graphData = chartsHelper.formatGraphData(d.colors, tws, d.labels, chartsHelper.addColorsToGraphData);
        data = [];
        arrayOfTweetsSource = _.map(_(tws).countBy("source"), function(value, key) {
          return [key, value];
        });
        arrayOfTweetsLanguage = _.map(_(tws).countBy("lang"), function(value, key) {
          return [key, value];
        });
        if (_(d.simple_charts).contains(d.chart)) {
          data = graphData;
        }
        ...
        req.source = _.sortBy(arrayOfTweetsSource, function(t) {
          return t[1];
        }).reverse();
        req.lang = _.sortBy(arrayOfTweetsLanguage, function(t) {
          return t[1];
        }).reverse();
        return next();
      });
  ...
  exports.index = function(req, res) {
    ...
    if (req.isAuthenticated()) {
      ...
      return Tweet.list(options, function(err, tws) {
        var arrayOfTweetsLanguage, arrayOfTweetsSource, graphData;
        if (err) {
          return next(err);
        }
        graphData = chartsHelper.formatGraphData(d.colors, tws, d.labels, chartsHelper.addColorsToGraphData);
        ...
        return res.render("index", {
          ...
          lang: _.sortBy(arrayOfTweetsLanguage, function(t) {
            return t[1];
          }).reverse(),
          source: _.sortBy(arrayOfTweetsSource, function(t) {
            return t[1];
          }).reverse(),
  ...
  */
  ...
  exports.update = function(req, res) {
    ...
    return tweet.uploadAndSave(req.files.image, function(err) {
      if (!err) {
  ...
  */
  ...
  exports.explore = function(req, res) {
    var user;
    user = req.user;
    return res.render("tweets/explore", {
      title: "Explore",
      user: user
    });
  };
